...
CREATE TABLE IF NOT EXISTS lots (
    ...
    expected_count INTEGER NOT NULL CHECK(expected_count BETWEEN 30 AND 1000),
    created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP
);
CREATE TABLE IF NOT EXISTS forecast_runs (
    ...
    UNIQUE(lot_id, input_hash, runtime_version)
);
CREATE TABLE IF NOT EXISTS screening_runs (
    run_id INTEGER PRIMARY KEY AUTOINCREMENT,
    lot_id TEXT NOT NULL REFERENCES lots(lot_id),
    epoch_h INTEGER NOT NULL,
    input_hash TEXT NOT NULL,
    runtime_version TEXT NOT NULL,
    created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
    payload TEXT NOT NULL,
    UNIQUE(lot_id, epoch_h, input_hash, runtime_version)
);
CREATE TABLE IF NOT EXISTS review_actions (
    ...
    action TEXT NOT NULL CHECK(action IN ('ACKNOWLEDGE','REQUEST_RETEST','HOLD','REJECT','APPROVE')),
